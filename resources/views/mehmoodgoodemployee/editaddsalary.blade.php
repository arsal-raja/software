...
<div class="col-sm-4">
<input type="text" readonly class="form-control form-control-round" value="{{$Salary[0]->advsalary}}" name="AdvanceSalary" id="AdvanceSalary">
</div>
...
$('#employee').change(function() {$('#amount').val('')});


	$('#other_deduction').focusout(function(){
		$d_amount = $(this).val();
		$salary = $('#Salary').val();
	    $advsalary = $('#AdvanceSalary').val();
