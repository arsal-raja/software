                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                              ...
                              <div class="col-span-6 mt-2 row">
									...
									<input type="text" style="font-size: 16px; font-weight: bold; color: black;" id="withdraw_bank" name="withdraw_bank" class="form-control form-control-round" value="{{ @$w_bank_name }}" disabled>

                                    	
                              </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Dath</label>
									<input type="text" style="font-size: 16px; font-weight: bold; color: black;" id="transfer_date" name="transfer_date" class="form-control form-control-round" value="{{ date('d-m-Y', strtotime($bank_transfer_details->date))}}" disabled>
                               
                                                              </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Deposit Bank</label>
									<input type="text" style="font-size: 16px; font-weight: bold; color: black;" id="deposit_bank" name="deposit_bank" class="form-control form-control-round" value="{{ @$d_bank_name }}" disabled>

                              </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Amount</label>
									<input type="text" id="amount" style="font-size: 16px; font-weight: bold; color: black;" name="amount" class="form-control form-control-round" value="{{ $bank_transfer_details->amount}}" disabled>
                                       
                              </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Description</label>
									<input type="text" id="transfer_description" style="font-size: 16px; font-weight: bold; color: black;" name="transfer_description" class="form-control form-control-round" value="{{ $bank_transfer_details->description }}" disabled>
                                      
                              </div>
                              </div>
                              <!-- <button style="" onclick="location.href='{{ url('add-bank-transfer') }}'" class="btns_reset btn btn-primary mt-5 btns_save">Back</button> -->
...
<label class="col-sm-10 col-form-label"></label>
		<div class="col-sm-2">
		<button type="button" style="" onclick="location.href='{{ url('add-bank-transfer') }}'" class="btns_reset">Back</button>
		</div>    
</div>
