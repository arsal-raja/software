										...
										<div class="container"><br><br>
											<div class="row">
												...
												<div class="col-md-4">
													...
													<div class="col-md-4">
												<a href="{{ route('add-bank-service-charge') }}">
															<div class="card mat-clr-stat-card text-white green ">
																<div class="card-block">
																	<div class="row">
																		<div class="col-3 text-center bg-c-green">
												...
												<div class="row">
													<div class="col-md-2"></div>
													<div class="col-md-4">
										<a href="{{ route('add-bank-transfer') }}">
														...
														<div class="col-md-4">
				        										<a href="{{ route('add-bank-deposit-withdrawl') }}">
													...
													<div class="row">
														...
														<div class="col-md-4">
															...
															<div class="col-md-4">
												        <a href="{{ route('add-bank-pettycash')}}">
																	<div class="card mat-clr-stat-card text-white green ">
																		<div class="card-block">
																			<div class="row">
																				<div class="col-3 text-center bg-c-green">
