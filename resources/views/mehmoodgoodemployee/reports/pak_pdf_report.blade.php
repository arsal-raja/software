...
<table style="text-align:center;" width="80%">
  ...
  <table style="text-align:center;" width="100%">
    <thead>
      <tr>
        <th width="8%" style="border:2px solid #c7c3c3;">S.no</th>
        ...
        <th width="10%" style="border:2px solid #c7c3c3;">Weight Kg</th>
    ...
    <tbody>
     ...
     @endphp
      <tr>
        <td width="8%" style="border:2px solid #c7c3c3;">{{$key+1}}</td>
        ...
        <td width="12%" style="border:2px solid #c7c3c3;">{{$destination}}</td>
         <td width="10%" style="border:2px solid #c7c3c3;">{{$value->weight ??''}}</td>
    ...
    @endforeach
    <tr>
        <td width="28%" style="border:2px solid #c7c3c3;">Total Cartons</td>
        <td width="10%" style="border:2px solid #c7c3c3;">{{$totalquantity}}</td>
        <td width="20%" style="border:2px solid #c7c3c3;"></td>
        <td width="12%" style="border:2px solid #c7c3c3;">Total Weight</td>
        <td width="10%" style="border:2px solid #c7c3c3;">{{ $totalweight ??''}}</td>
        <td width="20%" style="border:2px solid #c7c3c3;"></td>
    </tr>
      ...
      <table style="text-align:center;" width="100%">
        <thead>
          <tr>
            ...
            <th width="15%" style="border:2px solid #c7c3c3;">Bill #</th>
            <th width="20%" style="border:2px solid #c7c3c3;">Description</th>
            <th width="20%" style="border:2px solid #c7c3c3;">Destination</th>
            <th width="15%" style="border:2px solid #c7c3c3;">Weight Kg</th>
             <th width="10%" style="border:2px solid #c7c3c3;">Rate</th>
             <th width="10%" style="border:2px solid #c7c3c3;">TOTAL</th>
          </tr>
        </thead>
    ...
    @php
     ...
     @endphp
          <tr>
            ...
            <td width="15%" style="border:2px solid #c7c3c3;">{{$bill[0]->getbill[0]->id ??''}}</td>
            <td width="20%" style="border:2px solid #c7c3c3;">{{$value->description ??''}}</td>
            <td width="20%" style="border:2px solid #c7c3c3;"></td>
            <td width="15%" style="border:2px solid #c7c3c3;">{{$value->weight ??''}}</td>
            <td width="10%" style="border:2px solid #c7c3c3;">{{$value->rate ??''}}</td>
             <td width="10%" style="border:2px solid #c7c3c3;">{{$bill[0]->getbilty[0]->total_charges ??''}}</td>
          </tr>
    @endforeach
