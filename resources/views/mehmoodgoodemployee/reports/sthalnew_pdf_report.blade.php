  ...
  <table style="text-align:center;" width="100%">
    <thead>
      <tr>
        ...
        <th width="13%" style="border:2px solid #c7c3c3;">Description</th>
        <th width="12%" style="border:2px solid #c7c3c3;">Destination</th>
         <th width="10%" style="border:2px solid #c7c3c3;">Do#</th>
    ...
    @php
     ...
     @endphp
      <tr>
        ...
        <td width="13%" style="border:2px solid #c7c3c3;">{{$value->description ??''}}</td>
        <td width="12%" style="border:2px solid #c7c3c3;">{{$destination ??''}}</td>
         <td width="10%" style="border:2px solid #c7c3c3;">{{$bill[0]->getbilty[0]->ref_2 ??''}}</td>
    ...
    <tfoot>
      <tr>
        <td width="26%" style="border:2px solid #c7c3c3;">TOTAL CARTON/DRM&BAG
</td>
