  ...
  <tr>
   ...
   <tr>
    ...
    <table style="text-align:center;" width="100%">
        <thead>
          <tr>
            <th width="5%" style="border:2px solid #c7c3c3;">S.no</th>
            <th width="10%" style="border:2px solid #c7c3c3;">Date</th>
            <th width="7%" style="border:2px solid #c7c3c3;">T/R</th>
            <th width="6%" style="border:2px solid #c7c3c3;">CTN</th>
            <th width="15%" style="border:2px solid #c7c3c3;">Description</th>
            <th width="10%" style="border:2px solid #c7c3c3;">Destination</th>
            <th width="10%" style="border:2px solid #c7c3c3;">D/N #</th>
            <th width="7%" style="border:2px solid #c7c3c3;">Weight Kg</th>
            <th width="7%" style="border:2px solid #c7c3c3;">Extra Weight</th>
            <th width="8%" style="border:2px solid #c7c3c3;">Detension</th>
             <th width="7%" style="border:2px solid #c7c3c3;">Rate</th>
             <th width="8%" style="border:2px solid #c7c3c3;">TOTAL</th>
          </tr>
        </thead>
        <tbody>
            @php
    ...
    @php
     ...
     @endphp
              ...
              <tr>
                  <td width="5%" style="border:2px solid #c7c3c3;">{{$key+1}}</td>
                  <td width="10%" style="border:2px solid #c7c3c3;">{{$newDate}}</td>
                  <td width="7%" style="border:2px solid #c7c3c3;">{{$bill[0]->getbilty[0]->bilty_no ??''}}</td>
                  <td width="6%" style="border:2px solid #c7c3c3;">{{$value->quantity ??''}}</td>
                  ...
                  <td width="7%" style="border:2px solid #c7c3c3;">{{$bill[0]->weight ??''}}</td>
                  <td width="7%" style="border:2px solid #c7c3c3;">{{$bill[0]->extra_weight ??''}}</td>
                  <td width="8%" style="border:2px solid #c7c3c3;">{{$bill[0]->detention ??''}}</td>
                  <td width="7%" style="border:2px solid #c7c3c3;">{{$value->rate ??''}}</td>
                  <td width="8%" style="border:2px solid #c7c3c3;">{{$bill[0]->getbilty[0]->total_charges ??''}}</td>
              </tr>
            @endforeach
            <tr>
                <td width="22%" style="border:2px solid #c7c3c3;">Total Cartons</td>
                <td width="6%" style="border:2px solid #c7c3c3;">{{$totalquantity}}</td>
            </tr>
         </tbody>
    </table>
    ...
    <table style="text-align:center;" width="80%">
        ...
        <tr>
          <th colspan="3" style="text-align:left; font-size: 8px;">Net Tax Inclusive Vlaue:</th>
          <td  width="20%" style="border-bottom: 1px solid #000;"></td>
          <th colspan="13" style="text-align:right;">S.S.T 13%</th>
          <td width="17%" style="border:2px solid #c7c3c3;"></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td  width="20%" style="border-bottom: 1px solid #000;"></td>
          <th colspan="13" style="text-align:right; font-weight: bolder;">Total</th>
          <td width="17%" style="border:2px solid #c7c3c3;"></td>
        </tr>
