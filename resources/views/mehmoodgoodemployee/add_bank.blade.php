                                ...
                                <input type="hidden" name="id" value="{{$query->id}}">
                                   @endif 
                                    <div class="col-span-4">
                                          ...
                                          <input type="text"  id="bank_name" name="bank_name"  class="form-control form-control-round" placeholder="Enter Bank Name" value="{{ old('bank_name') }}">
                                    ...
                                    <div class="grid grid-cols-12 gap-2 mt-2 positon-relative senderForm">
                                       ...
                                       <div class="col-span-4">
                                          <label for="regular-form-4" class="form-label">Branch Name</label>
                                          <input id="branch_name" name="branch_name" class="form-control form-control-round" placeholder="Enter Branch Name" value="{{ old('branch_name') }}">
                                       @if ($errors->has('branch_name'))
                                    		<div class="alert alert-danger">{{ $errors->first('branch_name') }}</div>
	                                    	@endif
                                       </div>
                                       <div class="col-span-4">
                                          <label for="regular-form-1" class="form-label">Bank Address</label>
                                          <input type="Address" id="bank_address" name="bank_address" class="form-control form-control-round" placeholder="Enter Bank Address" value="{{ old('bank_address') }}">
...
<a href="{{ route('edit-bank',\Crypt::encrypt($value->id))}}"><i class="fa fa-pencil"></i></a>&nbsp;|&nbsp;
<a href="{{ route('delete-bank',\Crypt::encrypt($value->id))}}"><i class="fa fa-trash"></i></a>                                                             
   </td>
</tr>
	@php $count++; @endphp
	@endforeach
