                                   ...
                                   @endif 
                                    ...
                                    <div class="grid grid-cols-12 gap-2 mt-2 positon-relative senderForm">
                                       ...
                                       <div class="col-span-4">
                                          ...
                                          <input type="text"  name="amount" id="amount" class="form-control form-control-round" placeholder="Enter Amount" value="">
								    ...
								    @foreach($pettycashs as $pettycash)
										<tr>   
                                            ...
                                            <!--<td>-->
                                                ...
                                                <!--<a href="{{-- route('editpettycash',\Crypt::encrypt($pettycash->id)) --}}"><i class="fa fa-pencil"></i></a>&nbsp;|&nbsp;-->
