                ...
                <div class="col-sm-12">
                  ...
                  <div class="card">
                    ...
                    <div class="card-block">
                      ...
                      <form enctype="multipart/form-data" action="{{ route('updatepaidbilty') }}" method="post" class="bg-white post-form-validation" id="post-form-validation" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-2">
                            <div id="manual_sendenod" @if(isset($bilty->senderphone_id)) style="display: block;" @else style="display: none" @endif>
                            ...
                            <div id="manual_sendenodiv" @if(!isset($bilty->senderphone_id)) style="display: block;" @else style="display: none" @endif>
                            ...
                            <table class="table">
                              ...
                              <tbody class="package">
                                ...
                                <tr>
                                 ...
                                 <td >@if($count == 0)<button style="height: 47px;"  class="add_field_button1">Add More </button>@endif
                                 </td>
                               </tr>
                               @php $count++; @endphp
                               @endforeach
  ...
  function myFunctionsender() {
   ...
   document.getElementById("addressmanual").style.display='none';
    ...
    else
    {
      ...
      $.ajax({
        url:'{{URL::to('mehmoodgoodemployee/getpackagesdropdown')}}',
        type:'GET',
        async: false,
        data: { id: $('#sender_name').val() },
        success:function(data){
