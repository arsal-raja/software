                  ...
                  @if(Session::has('message')) <div class="alert alert-success"> {{Session::get('message')}} </div> @endif
                   @if(Session::has('error')) <div class="alert alert-danger"> {{Session::get('error')}} </div> @endif
                     @if(Session::has('info')) <div class="alert alert-info"> {{Session::get('info')}} </div> @endif
                      <form enctype="multipart/form-data" action="{{ route('createtopaybilty') }}" method="post" class="bg-white post-form-validation topay-normal" id="post-form-validation" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-4">
                            <label class="radio-inline">
                              <input  type="radio" value="ToPay"  name="biltytype" checked> To Pay
                            </label>
                            <label class="radio-inline">
...
<input   type="number" id="receiver_number" name="receiver_no" class="form-control form-control-round" placeholder="Receiver No" value="{{ old('sender_number') }}">
                          ...
                          <div class="col-sm-2">
                            <input   type="text" id="reference1" name="reference1" class="form-control form-control-round" placeholder="Reference No 2" value="{{ old('reference1') }}">
                          </div>
                        </div> 
                        ...
                        <div class="form-group row" id="deliveryRow">
                          ...
                          <div class="col-sm-2">
                            <input   type="text" id="reference2" name="reference2" class="form-control form-control-round" placeholder="Reference No 2" value="{{ old('reference2') }}">
                          </div>    
                            ...
                            <table class="table">
                              ...
                              <tbody class="package">
                                <tr>
                                  ...
                                  <td class="packingTd">
                                    <select required style="width:110px" required name="packing[]" id="packing" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary packing"  onchange="saveDisable();updateDescRegular($.now());">
                                  ...
                                  <td>
                                    ...
                                    <input  type="text" id="goods" name="goods[]"  class="orm-control goods" style="display:none;width:110px !important;border-radius:50px">
                                  </td>
                                  <td><input type="text" id="brand" name="brand[]"  class="form-control" style="width:110px !important;border-radius:50px"></td>
                                  <td><input onchange="myFunctionrate()" required type="text" id="rate" name="rate[]" class="form-control rate" style="width:110px !important;border-radius:50px"></td>
                            ...
                            <table class="table">
                              ...
                              <tbody class="package_walkin">
                                <tr>
                                  ...
                                  <!--<td class="packingTd">
                                    <input required type="text" class="testcheck1" id="walkinpacking" name="packing[]"  class="form-control packing" style="width:200px !important;border-radius:50px">       
                                  </td>-->
                                  <td class="packingTd">

                                    <!--<select required style="width:110px" required name="packing[]" id="walkinpacking_select" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary packing"  onchange="checkWalkingCustomerOthers()">
                                      <option value="">Select Package </option>
                                      ...
                                      @endforeach
                                      <option  value="others" data-description="others">others</option>

                                    </select>-->

                                    <input type="text" list="browsers" name="packing[]" id="walkinpacking" class="form-control packing {{time()}}val" style="display:;border-radius:50px;width:200px;" onChange="updateDescWalking({{time()}})">
                                    <datalist id="browsers">
                                      @foreach($packagemetas as $value)

                                          <option value="{{$value->package_name}}" data-description="{{$value->description}}" data-id="{{time()}}">
                                  ...
                                  <td><input required type="text" id="walkingood" name="good[]"  class="form-control {{time()}}" style="width:200px !important;border-radius:50px"></td>
                                  <td><input type="text" id="walkinbrand" name="brand[]"  class="form-control" style="width:110px !important;border-radius:50px"></td>
                            ...
                            <thead>
                             ...
                             <tbody>
                              ...
                              <tr>
                                ...
                                @endif
                                <td>{{$value->station->station_name ?? '' }}</td>
...
$(document).on('change','#karachi_to',function(event){
  
  var pid = $('.packing').find(':selected').val();
...
var option ='<option  value="">Select Phone</option>';
        for(var i=0;i<data.length;i++){
               ...
               option += '<option selected value="'+ data[i].id +'">' + data[i].number + '</option><option value="'+ data[i].id +'">Other</option>';
...
function myFunctionreceiverurdu() {
  var amount = $("#receiver_name").val();
