                ...
                <div class="col-sm-12">
                  ...
                  <div class="card">
                   ...
                   @if(Session::has('info')) <div class="alert alert-info"> {{Session::get('info')}} </div> @endif
                      ...
                      <form enctype="multipart/form-data" action="{{ route('createpaidbilty') }}" method="post" class="bg-white post-form-validation topay-normal" id="post-form-validation" enctype="multipart/form-data">
                            ...
                            <table class="table">
                              ...
                              <tbody class="package">
                                <tr>
                                  ...
                                  <td><input required type="text" id="good" name="good[]"  class="form-control" style="width:200px !important;border-radius:50px"></td>
                      ...
                      <form enctype="multipart/form-data" action="{{ route('createpaidbiltywalkin') }}" method="post" class="bg-white post-form-validation topay-walkin" id="post-form-validation" enctype="multipart/form-data">
                        <input type="hidden" value="{{ csrf_token() }}" name="_token" />
                        <meta name="csrf-token" content="{{csrf_token()}}">
                        @if ($errors->any())
                        <div class="alert alert-danger">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-2">
                            <div id="manual_sendenodiv">
                              <input  type="text" id="manual_senderno" name="manual_senderno" class="form-control form-control-round" placeholder="sender no" maxlength="11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required="">
                            </div>
                          </div>
                            ...
                            <table class="table">
                              ...
                              <tbody class="package_walkin">
                                <tr>
                                  ...
                                  <td><input required type="text" id="walkingood" name="good[]"  class="form-control" style="width:200px !important;border-radius:50px"></td>
                                  ...
                                  <td><input type="text" id="walkinweight" name="weight[]"  class="form-control weight" style="width:110px !important;border-radius:50px"></td>
