...
<!--											<center><h4>Petty Cash</h4></center>-->
<!--										</div>-->
<!--										<div class="container"><br><br>-->
<!--											<div class="row">-->
<!--												<div class="col-md-2"></div>-->
<!--												<div class="col-md-4">-->
<!--													<a href="{{url('/mehmoodgoodemployee/addpettycash')}}">		-->
...
<!--												</div>-->
<!--												<div class="col-md-4">-->
<!--													<a href="{{url('/mehmoodgoodemployee/addpettycashledger')}}">-->
<!--														<div class="card mat-clr-stat-card text-white green ">-->
<!--															<div class="card-block">-->
<!--																<div class="row">-->
<!--																	<div class="col-3 text-center bg-c-green">-->
...
<!--<div class="col-sm-4">-->
<!--<input type="date"   name="date" id="date" class="form-control form-control-round" placeholder="Enter Client Type">-->
<!--</div>-->
<!--<label class="col-sm-2 col-form-label">Deposit Cash</label>-->
<!--<div class="col-sm-4"> -->
<!--<select name="deposit_bank" id="deposit_bank"  class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary" disabled="disabled">-->
<!--<option value="opt1">Select Deposit Cash</option>-->
...
<!--<div class="col-sm-4">-->
<!--<input type="text"  name="amount" id="amount" class="form-control form-control-round" placeholder="Enter Phone Number">-->

<!--</div>-->

<!--<label class="col-sm-2 col-form-label">Description </label>-->
<!--<div class="col-sm-4">-->
<!--<input type="text"  name="description" id="description" class="form-control form-control-round" placeholder="Enter Phone Number">-->
<!--</div>    -->
<!--</div>-->
