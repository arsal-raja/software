...
@if(Session::has('info')) <div class="alert alert-info"> {{Session::get('info')}} </div> 
  @endif
 <form enctype="multipart/form-data" target="_blank" action="{{ route('generatecustomerledger') }}" method="post" class="bg-white post-form-validation topay-normal" id="post-form-validation" enctype="multipart/form-data">
...
<option value="ToPay">ToPay</option>
                        ...
                        <select required onchange="getcustomerbalance(this)"   name="customer_id" id="customer_id" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary" >
