								...
								<div class="col-sm-12">
									...
									<div class="card">
										<div class="card-header">
											<center><h4>Paid Receipt</h4></center>
										</div>
										<div class="container"><br><br>
											<div class="row">
												<div class="col-md-2"></div>
												<div class="col-md-4">
													<a href="{{url('/mehmoodgoodemployee/paidreceiptcustomer')}}">
												...
												<div class="col-md-2"></div>
												<div class="col-md-4">
													<a href="{{url('/mehmoodgoodemployee/paidreceiptbroker')}}">
														<div class="card mat-clr-stat-card text-white green ">
														<div class="card-block">
															<div class="row">
																<div class="col-3 text-center bg-c-green">
