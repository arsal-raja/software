...
@section('main-content')
 ...
 <div class="flex">
       ...
       @include('includes.side-nav')
            ...
            <!-- END: Top Bar -->
          <form action="{{ route('store-bank-deposit-withdrawl') }}" method="post">
                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                              ...
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-1"  class="form-label">Select a Type</label>
                                   <select name="type" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary">
                              ...
                              <div class="col-span-6 mt-2">
                                   ...
                                   <select name="bank" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary" id="bank">
		<option value="">Select Bank Name</option>
		@foreach($bank as $value)
		<option value="{{$value->id}}" {{ old('bank')==$value->id?"selected":"" }} data-id="{{ \Crypt::encrypt($value->id) }}">{{$value->branch->bank->name}}/{{$value->branch->name}}</option>
		@endforeach
	</select>
	@if ($errors->has('bank'))
...
@endif
                              ...
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Cheqe Number</label>
                                   <input type="text" id="cheque" name="cheque_number" class="form-control form-control-round" placeholder="Enter Cheque Number" value="{{ old('cheque_number') }}">
@if ($errors->has('cheque_number'))
	<div class="alert alert-danger">{{ $errors->first('cheque_number') }}</div>
@endif
                              </div>
                              <div class="col-span-6 mt-2">
...
<!--<label class="col-sm-2 col-form-label">Select a Type</label>-->
<!--<div class="col-sm-4"> -->
<!--	<select name="type" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary">-->
<!--		<option value="">Select transaction type</option>-->
<!--		@foreach($transactionType as $value)-->
