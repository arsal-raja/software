								...
								<div class="col-sm-12">
									...
									<div class="card">
										...
										<div class="card-header">
											...
											<center><h4>Daily Cash</h4></center>
										...
										<div class="container"><br><br>
											<div class="row">
												...
												<div class="col-md-4">
													...
													<a href="{{url('/mehmoodgoodemployee/cashrecipt')}}">		
												...
												<div class="col-md-4">
													<a href="{{url('/mehmoodgoodemployee/cashjournal')}}">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<a href="{{url('/mehmoodgoodemployee/cashreciptreports')}}">
