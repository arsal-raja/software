				...
				<div class="pcoded-content">
					...
					<div class="container">
						<div class="container-fluid">
                         ...
                         <center><h3 class="form_toheader"><u>Challan Forms</u></h3></center>
                                            </div>
										<div class="container"><br><br>
											<div class="row">
												<div class="col-md-2"></div>
												<div class="col-md-4">
			                              <a href="{{url('/mehmoodgoodemployee/challan')}}">
	
														<div class="card mat-clr-stat-card text-white green ">
														<div class="card-block">
															<div class="row">
																<div class="col-3 text-center bg-c-green">
																	<i class="fa fa-truck mat-icon f-24"></i>
																</div>
													...
													<div class="col-md-4">
			                              <a href="{{url('/mehmoodgoodemployee/challanreport')}}">
	
														<div class="card mat-clr-stat-card text-white green ">
														<div class="card-block">
															<div class="row">
																<div class="col-3 text-center bg-c-green">
																	<i class="fa fa-file-pdf-o mat-icon f-24"></i>
																</div>
																<div class="col-9 cst-cont">
