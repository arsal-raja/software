...
@section('main-content')
 ...
 <div class="flex">
       ...
       @include('includes.side-nav')
            ...
            <!-- END: Top Bar -->
           @if(@$bank_transfer->id != '')
                    <form action="{{ route('update-bank-transfer', @$bank_transfer->id) }}" method="post">
                    @else
                    <form action="{{ route('store-bank-transfer') }}" method="post">
                    @endif
                           ...
                           <div class="preview">
                              ...
                              <div class="col-span-6 mt-2 row">
                                ...
                                <select name="withdraw_bank" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary" id="bank">
                                    		...
                                    		<option value="{{$value->id}}" @if(@$bank_transfer->withdraw_bank_id == $value->id) selected @endif {{ old('withdraw_bank')==$value->id?"selected":"" }} data-id="{{ \Crypt::encrypt($value->id) }}">{{$value->branch->bank->name}}/{{$value->branch->name}}</option>
                                    		@endforeach
                                    	</select>
                              ...
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Dath</label>
                              ...
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Deposit Bank</label>
                                                                       <select name="deposit_bank" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary">
                                    		<option value="">Select Bank Name</option>
                                    		@foreach($bank as $value)
                                    		<option value="{{$value->id}}" @if(@$bank_transfer->deposit_bank_id == $value->id) selected @endif {{ old('deposit_bank')==$value->id?"selected":"" }} data-id="{{ \Crypt::encrypt($value->id) }}">{{$value->branch->bank->name}}/{{$value->branch->name}}</option>
                                    		@endforeach
                                    	</select>
                                    	@if ($errors->has('deposit_bank'))
                                    		<div class="alert alert-danger">{{ $errors->first('deposit_bank') }}</div>
                                    	@endif
                              </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Amount</label>
                                   <input type="text" id="amount" name="amount" class="form-control form-control-round" placeholder="Enter Amount" value="{{ old('amount', @$bank_transfer->amount) }}">
                              ...
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Description</label>
                                       <input type="text" id="description" name="description" class="form-control form-control-round" placeholder="Enter Description" value="{{ old('description',@$bank_transfer->description) }}">
			...
			<tr>
				...
				<td>{{$value->w_bank_account->branch->bank->name}}/{{$value->w_bank_account->branch->name}}</td>
				<td>{{$value->date}}</td>
				<td>{{$value->d_bank_account->branch->bank->name}}/{{$value->d_bank_account->branch->name}}</td>
				<td>{{$value->description}}</td>
				<td>{{$value->amount}}</td>
				<td>
					<a href="{{ route('view-transfer-details', $value->id) }}"><i class="fa fa-eye"></i></a>&nbsp;|&nbsp;
					<a href="{{ route('edit-bank-transfer', $value->id) }}"><i class="fa fa-pencil"></i></a>&nbsp;|&nbsp;
					<a href="{{ route('delete-bank-transfer', $value->id) }}"><i class="fa fa-trash"></i></a> 
				</td>
			</tr>
			@php $count++; @endphp
			@endforeach
...
<!--<div class="col-sm-4">-->
<!--<input type="date" id="date" name="date" class="form-control form-control-round" placeholder="Enter Client Type" value="{{ old('date',date('Y-m-d', strtotime(@$bank_transfer->date))) }}">-->
<!--@if ($errors->has('date'))-->
<!--	<div class="alert alert-danger">{{ $errors->first('date') }}</div>-->
<!--@endif-->
<!--</div>    -->
...
<!--<div class="form-group row">-->
<!--<label class="col-sm-2 col-form-label">Deposit Bank</label>-->
<!--<div class="col-sm-4">-->
<!--<select name="deposit_bank" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary">-->
<!--		<option value="">Select Bank Name</option>-->
<!--		@foreach($bank as $value)-->
...
<!--<div class="card">-->
<!--<div class="card-header">-->
<!--<h4>View Bank To Bank Transfer</h4>-->
<!--</div>-->
<!--<div class="card-block">-->
