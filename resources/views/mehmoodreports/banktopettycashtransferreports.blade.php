...
@section('main-content')
 ...
 <div class="flex">
                  ...
                  <div class="intro-y col-span-12 lg:col-span-12">
                     ...
                     <div class="intro-y box">
                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                         ...
                         Bank Pettycash Transfer Report
                           </h2>
                           ...
                           <div class="preview">
                              ...
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-1"  class="form-label">From Date</label>
														<input type="date" class="form-control form-control-round"  id="datepicker2" name="from" placeholder="Enter From Date">
                              </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">To Date</label>
														<input type="date" class="form-control form-control-round" id="datepicker3" name="to"  placeholder="EnterTo Date">
                              </div>
                              </div>
                              <button name="insertdata" class="btn btn-primary mt-5 btns_reset">Reset</button>
                                   <button href="{{url('mehmoodreports/generate_bank_to_pettycash_transfer_report')}}" type="Reset"  name="insertdata" class="btn btn-primary mt-5 btns_generate">Generate Reports</button>
     ...
     <!--                        											<h4>Bank Pettycash Transfer Report</h4>-->
					<!--					</div>-->
					...
					<!--								<div class="col-sm-2">-->
					<!--									<a href="{{url('mehmoodreports/generate_bank_to_pettycash_transfer_report')}}" type="Reset"  name="insertdata"class="btns_generate">Generate Report</a>-->
					<!--								</div>    -->
					<!--							</div>-->
					<!--			                  </form>-->
