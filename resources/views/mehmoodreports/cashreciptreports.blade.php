                     ...
                     <div class="intro-y box">
                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
							...
							<input type="date" class="form-control form-control-round"   name="from_date" id="from_date" placeholder="Enter Customer Name">
                              </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">To Date</label>
							<input type="date" class="form-control form-control-round" name="to_date" id="to_date"  placeholder="Enter Customer Name">
                              </div>
                              </div>
                              <button type="submit" name="insertdata" class="btn btn-primary mt-5 btns_cashreceipt">Cash Receipt</button>
                              <div class="btn btn-primary mt-5 btns_reset" >Reset</div>
   ...
   <form method="post" action="">
	...
	<select id="account_title" name="account_title" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary">
						...
						<input type="text" class="form-control form-control-round"  name="account_desc" id="account_desc" placeholder="Enter  Narration">
                              ...
                              <button type="submit" name="insertdata" class="btns_cashreceipt btn btn-primary mt-5 btns_cashreceipt">Title Report</button>
                              <div class="btn btn-primary mt-5 btns_reset" >Reset</div>
                     ...
                     <div class="intro-y box">
                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                               <div class="grid grid-cols-12 gap-6 mt-5">
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-1"  class="form-label">Select Cash Receipt Date</label>
                             		<input type="date" class="form-control form-control-round"  name="today_date" id="today_date" placeholder="Enter Select Cash Receipt Date">
                                        </div>
                              <div class="col-span-6 mt-2">
                                    <label for="regular-form-6" class="form-label">Select Account Title </label>
	<select id="account_title" name="account_title" class="form-control form-control-round mdb-select md-form colorful-select dropdown-primary">
						...
						<input type="text" class="form-control form-control-round"  name="account_desc" id="account_desc" placeholder="Enter  Narration">
                              ...
                              <button type="submit" name="insertdata" class="btns_generate btn btn-primary mt-5 btns_cashreceipt">Generate Report</button>
                              <div class="btn btn-primary mt-5 btns_reset" >Reset</div>
			...
			<!--			<div class="col-sm-2">-->
			<!--				<input type="submit" name="insertdata" class="btns_cashreceipt" value="Cash Receipt">-->
			<!--			</div>    -->
			<!--		</div>-->
			<!--	</form>-->
<!--			</div>-->
...
<!--				<form>-->
<!--					<div class="form-group row">-->
<!--						<label class="col-sm-2 col-form-label">Select Cash Receipt Date</label>-->
<!--						<div class="col-sm-4">-->
<!--							<input type="date" class="form-control form-control-round"  name="today_date" id="today_date" placeholder="Enter Select Cash Receipt Date">-->
<!--						</div>-->
<!--					</div> -->
