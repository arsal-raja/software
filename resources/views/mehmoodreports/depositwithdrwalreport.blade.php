...
@section('main-content')
 ...
 <div class="flex">
       ...
       @include('includes.side-nav')
                     ...
                     <div class="intro-y box">
                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                              ...
                              <button type="Reset"  name="insertdata" class="btn btn-primary mt-5 btns_reset">Reset</button>
                                   <button href="{{url('mehmoodreports/generate_bank_deposit_report')}}" type="Reset"  name="insertdata" class="btn btn-primary mt-5 btns_generate">Generate Reports</button>
			...
			<!--										<div class="col-sm-2">-->
			<!--<a href="{{url('mehmoodreports/generate_bank_deposit_report')}}" type="Reset"  name="insertdata"class="btns_generate">Generate Report</a>													</div>    -->
			<!--									</div>-->
			<!--					                  </form>-->
