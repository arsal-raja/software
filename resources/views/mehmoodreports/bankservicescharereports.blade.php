...
@section('main-content')
 ...
 <div class="flex">
	...
	<form method="post" target="_blank">               @csrf
            <div class="grid">
               ...
               <div class="grid grid-cols-12 gap-6 mt-5">
                  <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                              ...
                              <button name="insertdata" class="btn btn-primary mt-5 btns_reset">Reset</button>
                                   <button href="{{url('mehmoodreports/generate_bank_service_charges_report')}}" name="insertdata" class="btn btn-primary mt-5 btns_generate">Generate Reports</button>
					...
					<!--								<div class="col-sm-2" >	-->
					<!--									<a href="{{url('mehmoodreports/generate_bank_service_charges_report')}}" type="Reset"  name="insertdata" class="btns_generate">Generate Report</a>-->
