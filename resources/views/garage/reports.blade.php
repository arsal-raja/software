                    ...
                    <ul>
                        ...
                        <div id="Inventory">
                            <div id="input" class="p-5">
                                ...
                                <form autocomplete="off" method="post" action="{{route('garagereportgenerate')}}">
                                    @csrf
                              <div class="mt-2 grid grid-cols-12 gap-2 positon-relative">
                              <div class="col-span-4 positon-relative">
                                 <label for="regular-form-2" class="form-label">Select Vehicle</label>
                                <select  name="companyName" class="form-control">
                                 <option value="">Select Vehicles</option>
                                    @foreach($vehicles  as $rowvehicles)
                                    <?php 
                                    $vehicleNO = DB::table('vehicles')->where('id',$rowvehicles->Truck_Name)->first(); 
                                    ?>
                              ...
                              <div class="col-span-4 positon-relative">
                                ...
                                <input id="regular-form-2" name="From" type="date" class="form-control" >
                              </div>  
                              
                              <div class="col-span-4 positon-relative">
                                 <label for="regular-form-2" class="form-label">To Date</label>
                                <input id="regular-form-2" name="to" type="date" class="form-control" >
                              </div>  
                              
                               <div class="col-span-4 positon-relative">
                                 <label for="regular-form-2" class="form-label">Type</label>
                            ...
                            <button type="submit" class="btn btn-success mt-5">Show</button>
                            </form>
                            <BR>
                                ...
                                <table id="example" class="display nowrap" style="width:100%">
                                 ...
                                 <tbody>
                                     <?php $counter = 1; ?>
                                   @foreach($viewReports as $rowReports)
 <?php
$products =  DB::table('category')->where('id',$rowReports->garage_inventory)->first();
$vehicles =  DB::table('vehicles')->where('id',$rowReports->Truck_Name)->first();
$shop =  DB::table('autoshop')->where('id',$rowReports->shopName)->first();
 ?>
                                   
                                   <tr>
                                 <td>{{$counter++}}</td>
                                 <td>{{$products->Des}}</td>
                                 <td>{{$rowReports->Quantity}}</td>
                                 <td>{{$rowReports->UnitPrice}}</td>
                                 <td>{{$rowReports->Amount}}</td>
                                 <td>{{$shop->ShopName}}</td>
                                 <td>{{$vehicles->vehicleno}}</td>
                                 
                                 <td>{{$rowReports->status}}</td>
                                 <td>{{$rowReports->Garage_date}}</td>
                                   </tr>
                                   @endforeach
