                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                              ...
                              <div class="col-span-4 mt-2">
                                 ...
                                 <input  name="accident" type="hidden" value="1">
                               ...
                               <div class="col-span-4 mt-2">
                                 <label for="txtBox" class="form-label">Autoshop</label>
                                  <select onchange="find()" id="garageauto" class="form-control" id="vehicleNo" name="garageauto">
                                      <option value="">select autoShop</option>
...
//dd($rowtables->garage_inventory);
                                           ...
                                           <td>{{$products->Des}}</td>
                                            ...
                                            <td><a href="{{route('Edit-vehicle-Accident',['id'=>$rowtables->id])}}">Edit </a> |  <a href="{{route('delete_vehicle_expense',['id'=>$rowtables->id])}}">Delete </a>  </td>
                                    </tr>
                                    @endforeach
                              </table>
