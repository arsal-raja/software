...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Head Office</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
               ...
               <div class="grid grid-cols-12 gap-6 mt-5">
                  ...
                  <div class="intro-y col-span-12 lg:col-span-12">
                     ...
                     <div class="intro-y box">
                        ...
                        <form method="post" autocomplete="off" @if(!empty($query)) action="{{route('save-edit-cash-statment')}}" @endif @if(empty($query)) action="{{route('save-cash-statment')}}" @endif>
                         @csrf
    ...
    <input id="regular-form-2"  type="date" @if(!empty($query))  value="{{$query->Date}}"  @endif name="headdate" class="form-control" placeholder="Enter Name" >
                                 </div>
                                    

                              <div class="col-span-4 positon-relative">
                                 <label for="txtBox" class="form-label">Cash Category</label>
    <select id="regular-form-2"  type="text" @if(!empty($query))  value="{{$query->Cash_Category}}"  @endif name="cashcategory" class="form-control cashamountchange" placeholder="Enter Name" >
      <option>please select</option>
      <option>Reciept</option>
      <option>Paymnents</option>
            </select>
                                 </div>
                            ...
                            <div class="col-span-4 positon-relative">
                              ...
                              <label for="txtBox" class="form-label">Discription</label>
                                 <input id="regular-form-2" type="text" @if(!empty($query))  value="{{$query->Head_Desctiption}}"  @endif   name="cashdescription" class="form-control" placeholder="Enter Discription" >
                              ...
                              <label for="txtBox" class="form-label">Refrence</label>
                                 <input id="regular-form-2" type="text" @if(!empty($query))  value="{{$query->Reference}}"  @endif   name="headreference" class="form-control" placeholder="Enter Discription" >
                  ...
                  <div id="recieptamount" style="display: none;" class=" col-span-4 positon-relative">
                              ...
                              <label for="txtBox" class="form-label">Reciept Amount</label>
                                 <input id="regular-form-2" type="text" @if(!empty($query))  value="{{$query->Reciept_Amount}}"  @endif   name="recieptamount" class="form-control" placeholder="Enter Reciept Amount" >
                              ...
                              <input id="regular-form-2"  type="text" @if(!empty($query))  value="{{$query->Payment_Amount}}"  @endif name="paymentamount" class="form-control" placeholder="Enter Payment Amount" >
...
<?php $serial += 1; ?>
  ...
  <td>{{$values->Reciept_Amount}}</td>
      ...
      <td>
       <a href="{{route('edit-head-statement', ['id' => $values->id]) }}">Edit</a>  |
         <a href="{{route('delete-head-statement', ['id' => $values->id]) }}">Delete</a>  
...
@section('script')
<script>
   $('.cashamountchange').on('change',function(){
