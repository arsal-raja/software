...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <form method="post" autocomplete="off" action="{{route('add-nill-labour-process')}}"> 
               @csrf
            <div class="grid">
                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                              ...
                              <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Labour Date</label>
                                  <input id="regular-form-5" readonly type="text" class="form-control" value="{{$date}}" name="labour_date">
                              </div>
                              </div>
