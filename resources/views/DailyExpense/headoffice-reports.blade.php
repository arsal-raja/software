               ...
               <div class="grid grid-cols-12 gap-6 mt-5">
                  ...
                  <div class="intro-y col-span-12 lg:col-span-12">
                     ...
                     <div class="intro-y box">
                        ...
                        <form method="Post" action="{{route('get-headoffice-report')}}">
                           @csrf
                           <h2 class="font-medium text-base mr-auto">

                View Head Office Reporst
                     ...
                     <input id="regular-form-2"  type="date" name="headfromdate" class="form-control" placeholder="Enter Amount" >
                                 </div>
                                     <div class="col-span-4 positon-relative">
                                 <label for="txtBox" class="form-label">To Date</label>
                     <input id="regular-form-2"  type="date" name="headtodate" class="form-control" placeholder="Enter Amount" >
                                 </div>
...
<button   class="btn btn-danger mt-5">Generate</button>
