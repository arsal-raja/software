               ...
               <div class="grid grid-cols-12 gap-6 mt-5">
                  ...
                  <div class="intro-y col-span-12 lg:col-span-12">
                     ...
                     <div class="intro-y box">
                        ...
                        <form method="Post" action="{{route('get-campus-report')}}">
                           @csrf
                     ...
                     <input id="regular-form-2"  type="date" name="campusfromdate" class="form-control" placeholder="Enter Amount" >
                                 </div>
                                     <div class="col-span-4 positon-relative">
                                 <label for="txtBox" class="form-label">To Date</label>
                     <input id="regular-form-2"  type="date" name="campustodate" class="form-control" placeholder="Enter Amount" >
                                 </div>
