...
@section('main-content')
 ...
 <div class="flex">
            ...
            <div class="grid">
               ...
               <div class="intro-y flex items-center mt-12">
                  ...
                  <h2 class="text-lg font-medium mr-auto">
                    ...
                    Daily Labour Payment Account Reports
                  </h2>
               ...
               <form method="post" autocomplete="off" action="{{route('get-account-reports')}}">
                         @csrf
    ...
    <input id="regular-form-2"  type="date"  name="fromdate" class="form-control" placeholder="Enter date" >
                                 </div>
