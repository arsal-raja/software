 ...
 <div class="flex">
       @include('includes.side-nav')
         <!-- BEGIN: Content -->
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Employee Ledger</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
  ...
  <div class="clearfix"></div>
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Selected Employee Information</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <table id="datatable" class="table table-responsive table-condensed table-bordered">
              ...
              <tbody>
                <?php $balance = 0; ?>
								@foreach($employee_ledger as $row)
                <tr>
                  <td>{{$row->el_id}}</td>
                  <td>
                    <?php
                  ...
                  <td><?php echo $debit = $row->el_debit; ?></td>
                  <td><?php echo $credit = $row->el_credit; ?></td>
                  <td>
        						<?php
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <form name="form2" method="post" action='{{url('getEmployeeWiseLedgerReport')}}'>
                  <input type="hidden" value="{{csrf_token()}}" name="_token" />
                  <input type="hidden" value="{{$employee_id}}" name="id" />
