  ...
  <div class="">
    <div class="clearfix"></div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <form method="post" action='{{url('getEmployeeLedgerRecord')}}'>
                <input type="hidden" value="{{csrf_token()}}" name="_token" />
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                  <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Employee's Name</span>
                  </label>
                  <meta name="csrf-token" content="{{csrf_token()}}">
                  <div class="col-md-8 col-sm-8 col-xs-12">
                      <select name="employee_id" id="employee_id" class="form-control col-md-7 col-xs-12">
                        <option value="-1">Please select a employee</option>
                ...
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <input type="submit" id="view" name="insertdata" class="btn btn-success" value="View Employee Info">
                  </div>
                </div>
              </form>
            </span>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Generate Date Wise Ledger Report of Employee</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <!-- FORM STARTS HERE -->
            <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              @if(Session::has('message')) <div class="alert alert-success"> {{Session::get('message')}} </div> @endif
              <form name="form2" method="post" action='{{url('getEmployeeLedgerReport')}}'>
                <input type="hidden" value="{{csrf_token()}}" name="_token" />
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                  <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Select a employee
                  </label>
                  <meta name="csrf-token" content="{{csrf_token()}}">
                  <div class="col-md-8 col-sm-8 col-xs-12">
