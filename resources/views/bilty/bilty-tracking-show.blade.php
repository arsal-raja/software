            ...
            <div class="intro-y col-span-12 lg:col-span-12">
               ...
               <div class="intro-y box">
                  ...
                  <div id="input" class="p-5">
                                    ...
                                    <table id="" class="display nowrap" style="width: 100%; text-align: center;" role="grid" aria-describedby="example_info">
                                          <thead>
                                             <tr role="row">
...
<table id="" class="display nowrap" style="width: 100%; text-align: center;" role="grid" aria-describedby="example_info">
                                          ...
                                          <tbody>
                                             @foreach($biltyitems as $rowbiltyitems)
                                             <tr>
                                             <td>{{$rowbiltyitems->packagename}}</td> 
                                               <td>{{$rowbiltyitems->brand}}</td>
                                               <td>{{$rowbiltyitems->quantity}}</td>      
                                               <td>{{$rowbiltyitems->rate}}</td>
                                               <td>{{$rowbiltyitems->weight}}</td>
                                               <td>{{$rowbiltyitems->total}}</td>
                                            </tr>
                                             @endforeach
                                          </tbody>
