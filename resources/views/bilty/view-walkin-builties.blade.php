...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">View Walking Bilty</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
...
<script type="text/javascript">
 $(document).on('change','#search', function(){
  ...
  $.ajax({
    type:'GET',
    url:"{{url('/view-walkin-builty')}}",
    async: false,
    data: {'search':current_context,'type':'Walkin'},
