...
@section('main-content')
 ...
 <div class="flex">
         ...
         <form method="post" action="save-amaount-calculation">
             @CSRF
         <div class="grid">
                        ...
                        <div class="preview">
                           <div class="grid grid-cols-12 gap-2 mt-2 positon-relative GoodCalculation">
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Rent</label>
                                 <input type="text" placeholder="Enter Rent" class="form-control" name="rent">
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Labour</label>
                                 <input type="text" placeholder="Enter Labour" class="form-control" name="labour">
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">IT</label>
                                 <input type="text" placeholder="Enter IT" class="form-control" name="it">
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Local Charges</label>
                                 <input type="text" placeholder="Enter Local Charges" class="form-control" name="lc">
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Lift/Crane Charges</label>
                                 <input type="text" placeholder="Enter Lift/Crane Charges" class="form-control" name="lcc">
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Home Delivery</label>
                                 <input type="text" placeholder="Enter Home Delivery" class="form-control" name="hd"> 
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Other Charges</label>
                                 <input type="text" placeholder="Enter Other Charges" class="form-control" name="otc">
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Total Amount</label>
                                 <input type="text" value="{{--$sumtotalamount--}}" placeholder="Enter Total Amount" class="form-control" name="ta">
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Advance</label>
                                 <input type="text" placeholder="Enter Advance" class="form-control"  name="advance">
                                   <input type="hidden" value="{{$builtyID}}" name="builtyid">
                              </div>
                              <div class="col-span-3">
                                 <label for="regular-form-1" class="form-label">Balance</label>
                                 <input type="text" placeholder="Enter Balance" class="form-control" name="balance">
                              </div>
                           </div>
