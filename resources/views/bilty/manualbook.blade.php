...
<div class="content">
   ...
   <div class="top-bar">
      <!-- BEGIN: Breadcrumb -->
      <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Manual Book</a> </div>
      <!-- END: Breadcrumb -->
      <!-- BEGIN: Search -->
   ...
   <!-- END: Top Bar -->
   <form method="post"  autocomplete="off" action="{{route('save-mannual-book')}}">
                     ...
                     <div class="preview">
                        <div class="grid grid-cols-12 gap-2">
                                ...
                                <div class="col-span-4">
                                  <label for="regular-form-1"  class="form-label">TR NO</label>
                                 <select name="id" class="form-control">
                                     <option value=''>Choose Bilty</option>
                                    @foreach($builties as $builty)
                                     <option>{{$builty->id}}</option>
                                ...
                                <div class="col-span-4">
                                  <label for="regular-form-2" class="form-label">Tax</label>
                                  <input required  type="number" class="form-control" placeholder="Tax" name="Tax">
                               </div>
                               
                               <div class="col-span-4">
                                  <label for="regular-form-1"  class="form-label">Bill Status</label>
   ...
   <table id="examples" class="display nowrap" style="width:100%">
                                 ...
                                 <tbody>
                                    @foreach($view as $viewRow)
                                          ...
                                          <td> <a href="{{route('edit-mannual-book',['id' =>$viewRow->id])}}"> Edit </a> |
                                          <a href="{{route('delete-mannual-book',['id' =>$viewRow->id])}}"> Delete </a> | 
                                          <a href="{{route('generate-mannual-book',['id' =>$viewRow->id])}}"> Generate </a> </td>
