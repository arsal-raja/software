            ...
            <div class="intro-y col-span-12 lg:col-span-12">
               ...
               <div class="intro-y box">
                  ...
                  <div id="input" class="p-5">
                     <form method="post" action="{{route('edit-tracking-builty-search')}}">
                         @csrf
                         <input type="hidden" name="serialid" value="{{$editbilty->id}}">
                        <div class="grid">
                        </div>
                        <div class="grid grid-cols-12 gap-6 mt-5">
                           <div class="intro-y col-span-12 lg:col-span-12">
                                 ...
                                 <div id="input" class="p-5">
                                    <div class="grid grid-cols-12 gap-2 mt-2">
                                       <div class="col-span-6">
                                          ...
                                          <select readonly id="regular-form-2"class="form-control" name="companyName">
                                             @foreach($company as $comrow)
                                             <option value="{{$comrow->id}}" @if($comrow->id == $editbilty->companyName) {{'selected'}} @endif>{{$comrow->name}}</option>
                                             @endforeach
                                          </select>
                                       </div>
                                       <BR>
                                    ...
                                    <div class="grid grid-cols-12 gap-2 addbuiltyNumber">
                                       <div class="col-span-4 hello">
                                          ...
                                          <select  id="regular-form-2" readonly  class="form-control" name="builtyid">
                                             <option></option>
                                             @foreach($builty as $brow)
                                             <option value="{{$brow->id}}" @if($brow->id == $editbilty->builtyNO) {{'selected'}} @endif>{{$brow->id}}</option>
                                             @endforeach
                                          </select>
                                       </div>
                                    ...
                                    <div class="grid grid-cols-12 gap-2 mt-2">
                                       <div class="col-span-6">
                                          ...
                                          <select id="regular-form-2" name="stations" class="form-control">
                                             ...
                                             <option value="{{$rowsta->id}}" @if($rowsta->id == $editbilty->Station) {{'selected'}} @endif  >{{$rowsta->name}}</option>
                                             @endforeach
                                          </select>
                                       </div>
                                    </div>
