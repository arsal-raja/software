...
"><span class="farhan">'.(!empty($brand[0])?  $brand[0] : '').'</span></foreignObject>
         ...
         <g id="logo">
            <image style="overflow:visible;enable-background:new;" width="787" height="140" id="image-2" xlink:href="'.$path2.'/'.$selfcompanyc->logo.'"  transform="matrix(1 0 0 1 1290.4515 93.9059)">
             ...
             <g id="logo-3">
<image style="overflow:visible;enable-background:new;" width="787" height="140" id="image-2_2_" xlink:href="https://asaanapps.com/SaifDataFile/PakHakeemGoods.png" transform="matrix(1 0 0 1 380.4515 89.9059)">
            </image>
         </g>
...
<foreignObject xmlns="http://www.w3.org/2000/svg" id="_1-2" class="st17" d="M814,1403.3h957.2v256.5H814V1403.3z" style="">
        ...
        <path id="Shape_5_copy_4" class="st1" d="M1440.1000,137.7H491.6" transform="matrix(1 0 0 1 332.0536 2970.8707)"></path>
         ...
         <g id="logo-3">
<image style="overflow:visible;enable-background:new;" width="787" height="140" id="image-2_2_" xlink:href="https://asaanapps.com/SaifDataFile/PakHakeemGoods.png" transform="matrix(1 0 0 1 380.4515 1829.9059)">
            </image>
         </g>
