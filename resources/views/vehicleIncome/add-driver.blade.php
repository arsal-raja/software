      ...
      <!-- BEGIN: Content -->
         ...
         <div class="content">
            ...
            <div class="top-bar">
               ...
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Driver</a> </div>
            ...
            <!-- END: Top Bar -->
   <form autocomplete="off" method="post" @if(!empty($query)) action = "{{route('save-edit-driver')}}"  @else action = "{{route('insert-driver')}}" @endif  >
      @csrf
            <div class="grid">
                     ...
                     <div class="intro-y box">
                        ...
                        <div id="input" class="p-5">
                           ...
                           <div class="preview">
                               ...
                               <div class="mt-2 grid grid-cols-12 gap-2 positon-relative cityDivbar">

                              <div class="col-span-12 positon-relative">

                                  <div class="mt-2">

                                 <label for="txtBox" class="form-label">Driver Name</label>

                                 <input @if(!empty($query)) value="{{$query->DriverName}}"@endif id="regular-form-1" name="DriverName" class="form-control " >
                                
                                    @if(!empty($query))
                                    <input type="hidden" value="{{$query->id}}" id="regular-form-1" name="id" class="form-control " >
                                    @endif
                                </div>
...
<td>
<a href="{{route('edit-driver',['id'=>$row->id])}}"> Edit  </a>  |
<a href="{{route('delete-driver',['id'=>$row->id])}}"> Delete </a> 
