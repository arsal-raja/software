   ...
   @include('includes.side-nav')
         ...
         <div class="content">
            ...
            <div class="top-bar">
               ...
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Vehicle Income</a> </div>
            ...
            <!-- END: Top Bar -->
                <form method="post"  @if(!empty($query)) action="{{route('edit-income-process')}}" @endif @if(empty($query)) action="{{route('income-details')}} " @endif>
               @csrf
            <div class="grid">
                        ...
                        <div class="mt-2">
                             ...
                             <div class="mt-2">
                                 ...
                                 <label for="regular-form-4" class="form-label">Discription</label>
                                       <div class="error"></div>
                                 <input id="regular-form-4"  @if(!empty($query)) value="{{$query->discription}}" @endif name="discription" type="text" class="txtOnly form-control" placeholder="Discription">
                              ...
                              <table id="example" class="display nowrap" style="width:100%">
                                 ...
                                 <thead>
                                  ...
                                  <tbody>
                                               ...
                                               @foreach ($dataa as $emplyr)

                                          
                                           <tr>   
                                              <td>{{$emplyr->id}}</td>
                                              <td>{{$emplyr->name}}</td>
                                              <td>{{$emplyr->discription}}</td>
                                              <td><a href="{{url('edit-income', ['id' =>  $emplyr->id] ) }}">Edit</a>
                                                <a href="{{url('delete-income', ['id' =>  $emplyr->id] ) }} ">Delete</a></td>
