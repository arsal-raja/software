...
<div class="content">
   ...
   <!-- END: Top Bar -->
   <form method="post" action="{{route('savevehicleaccidentManagement')}}" >
      @csrf
      <div class="grid">
                  ...
                  <div id="input" class="p-5">
                     <div class="preview">
                        <div class="mt-2">
                           ...
                           <?php  
                           $vehicleNO = DB::table('vehicles')->where('id',$id)->first();
                           ?>
                            <input name="VehicleNO" readonly value="{{$vehicleNO->vehicleno}}"type="text" class="form-control" placeholder="Enter Reason">
                              <input name="id" value="{{$id}}"type="hidden" class="form-control">
                        </div>
                        <div class="mt-2">
                           <label for="regular-form-2" class="form-label">Reason</label>
