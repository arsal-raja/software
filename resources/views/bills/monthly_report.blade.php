...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <!-- END: Top Bar -->
           <form method="post" action="{{url('monthly-billing-report')}}" class="BillForm_______">
               @csrf
            <div class="grid">
               ...
               <div class="grid grid-cols-12 gap-6 mt-5">
                  <div class="intro-y col-span-12 lg:col-span-12">
                   ...
                   <div class="mt-2">
                        <label class="form-label col-md-2 col-sm-2 col-xs-12">From Date :
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="month" name="month" class="form-control col-md-7 col-xs-12" value="{{date('F Y')}}" />
                       </div>
