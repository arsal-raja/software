...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <!-- END: Top Bar -->
           <form method="post" action="{{url('outstanding-bill-report')}}" class="BillForm_______">
               @csrf
            <div class="grid">
                  ...
                  <div class="intro-y col-span-12 lg:col-span-12">
                     ...
                     <div class="intro-y box">
                        ...
                        <div id="input" class="p-5" style="padding-bottom: 65px;">
                           <div class="preview">
                               <div class="mt-2">
                                    <label class="form-label col-md-2 col-sm-2 col-xs-12">Select Customer
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <select name="customer_id" class="form-control col-md-7 col-xs-12">
