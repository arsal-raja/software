...
<div class="flex">
   ...
   <!-- BEGIN: Content -->
    <div class="content">
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Commisssion Book</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
            ...
            <form method="post" action="{{route('saveeditcommission')}}" autocomplete="off">
               @csrf
...
<foreignObject xmlns="http://www.w3.org/2000/svg" id="_1-2" data-name="1" class="cls-1" x="890.999" y="232" width="90" height="635">
        <body xmlns="http://www.w3.org/1999/xhtml">
        <input type="text" @if(!empty($view)) readonly @endif y="232"  value="{{$select->DIK}}" name="DIK" />
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->Sarailagon}}" name="Sarailogin"/>
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->Bannu}}" name="Bannu"/>
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->MirAnsha}}" name="MirAnsha"/>
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->Kohat}}" name="Kohat"/>
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->Peshawar}}" name="Pesharwar"/>
        <input type="hidden" value="{{$select->id}}" name="id"/>
        <input type="text"   value="" />
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->wapsirent}}" name="wapsirent"/>
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->total}}" name="total"/>
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->bakaya}}" name="bakaya" />
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->totalcash}}" name="totalcash"/>
        <input type="text"  value=""/>
        <input type="text" value=""/>
        <input type="text" value=""/>
        <input type="text" value=""/>
        ...
        <input type="text" value=""/>
        <input type="text" value=""/>
        <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->remaincashwithvehicle}}" name="remaincashwithvehicle" />
    <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->cashreceived}}" name="cashreceived" />
    <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->totalcash1}}" name="totalcash1"/>
    <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->totalExpense}}" name="totalExpense"/>
    <input type="text" @if(!empty($view)) readonly @endif  value="{{$select->cashwithvehicle}}" name="cashwithvehicle"/>
        <input type="text" value=""/>
        <input type="text" value=""/>
        <input type="text" value=""/>
        <input type="text" value=""/>
...
<foreignObject xmlns="http://www.w3.org/2000/svg" id="_1-2" data-name="1" class="cls-1" x="650.999" y="228" width="90" height="635">
        <body xmlns="http://www.w3.org/1999/xhtml">
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->Deasil}}" name="Desiel"/>
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->mobile}}" name="MobileCall"/>
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->Toll}}" name="Toll"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select->MotarPolice}}" name="Motarwaypolice"/>
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->ChaiPani}}" name="Chai"/>
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->Manshiat}}" name="Manshiat "/>
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->SpareParts}}" name="parts "/>
<input type="text" value="" />
<input type="text" value=""/>
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->Grease}}" name="Grease"/>
<input type="text" value="" />
<input type="text" value="" />
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->AirCheck}}" name="AirCheck" />
<input type="text" value=""/>
<input type="text" value=""/>
<input type="text" value="" />
<input type="text"@if(!empty($view)) readonly @endif value="{{$select->munshiana}}" name="munshiana" />
<input type="text"@if(!empty($view)) readonly @endif value="{{$select->Labor}}" name="Labor" />
<input type="text"@if(!empty($view)) readonly @endif value="{{$select->KarachiAddaCommission}}" name="karachiAdda"   />
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->WapisAddaCommission}}" name="WapasAddaCommission"  />
<input type="text" value="" />
<input type="text" value=""/>
<input type="text" value=""/>
<input type="text"@if(!empty($view)) readonly @endif value="{{$select->GariService}}" name="Service"/>
<input type="text"@if(!empty($view)) readonly @endif value="{{$select->Kanta}}" name="Kanta"/>
<input type="text" value=""/>
<input type="text" value=""/>
<input type="text"@if(!empty($view)) readonly @endif value="{{$select->MechanicLabor}}" name="MechanicLabor"/>
...
<!-- Stations -->
<foreignObject
 xmlns="http://www.w3.org/2000/svg" id="_1-2" data-name="1" class="cls-1 cls-1__line___" x="475.999" y="232" width="90" height="635">

 <?php

$select1 = DB::table('commissionstationcharges')->where('CommsionBookID',$select->id)->first();
 ?>
        <body xmlns="http://www.w3.org/1999/xhtml">
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station1}}" name="station1"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station2}}" name="station2"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station3}}" name="station3"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station4}}" name="station4"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station5}}" name="station5"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station6}}" name="station6"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station7}}" name="station7"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station8}}" name="station8" />
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station9}}" name="station9"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station10}}" name="station10"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station11}}" name="station11" />
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station12}}" name="station12" />
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station13}}" name="station13" />
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station14}}" name="station14"/>
    <input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->Station15}}" name="station15"/>
...
<!-- Current Bakaya -->
<foreignObject
 xmlns="http://www.w3.org/2000/svg" id="_1-2" data-name="1" class="cls-1 cls-1__line___1" x="395.999" y="232" width="90" height="635">
        <body xmlns="http://www.w3.org/1999/xhtml">
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance1}}" name="currentRemain1"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance2}}" name="currentRemain2"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance3}}" name="currentRemain3"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance4}}" name="currentRemain4"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance5}}" name="currentRemain5"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance6}}" name="currentRemain6"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance7}}" name="currentRemain7"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance8}}" name="currentRemain8"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance9}}" name="currentRemain9"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance10}}" name="currentRemain10" />
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance11}}" name="currentRemain11" />
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance12}}" name="currentRemain12" />
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance13}}" name="currentRemain13"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance14}}" name="currentRemain14"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->currentBalance15}}" name="currentRemain15"/>
...
<!-- Remain Bakaya -->
<foreignObject
 xmlns="http://www.w3.org/2000/svg" id="_1-2" data-name="1" class="cls-1 cls-1__line___2" x="275.999" y="232" width="90" height="635">
        <body xmlns="http://www.w3.org/1999/xhtml">
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance1}}" name="Remain1"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance2}}" name="Remain2"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance3}}" name="Remain3"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance4}}" name="Remain4"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance5}}" name="Remain5"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance6}}" name="Remain6"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance7}}" name="Remain7"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance8}}" name="Remain8" />
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance9}}" name="Remain9"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance10}}" name="Remain10"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance11}}" name="Remain11" />
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance12}}" name="Remain12" />
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance13}}" name="Remain13" />
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance14}}" name="Remain14"/>
<input type="text"  @if(!empty($view)) readonly @endif  value="{{$select1->PreviousBalance15}}" name="Remain15"/>
...
<!-- Total Bakaya -->
<foreignObject
 xmlns="http://www.w3.org/2000/svg" id="_1-2" data-name="1" class="cls-1 cls-1__line___4" x="160.999" y="232" width="90" height="635">
        <body xmlns="http://www.w3.org/1999/xhtml">
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance1}}"  name="stationTotal1"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance2}}"  name="stationTotal2"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance3}}"  name="stationTotal3"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance4}}"  name="stationTotal4"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance5}}"  name="stationTotal5"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance6}}"  name="stationTotal6"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance7}}"  name="stationTotal7"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance8}}"  name="stationTotal8" />
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance9}}"  name="stationTotal9"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance10}}" name="stationTotal10"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance11}}" name="stationTotal11" />
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance12}}" name="stationTotal12" />
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance13}}" name="stationTotal13" />
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance14}}" name="stationTotal14"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TotalBalance15}}" name="stationTotal15"/>
...
<!-- Remarks -->
<foreignObject
 xmlns="http://www.w3.org/2000/svg" id="_1-2" data-name="1" class="cls-1 cls-1__line___4" x="50.999" y="232" width="90" height="635">
        <body xmlns="http://www.w3.org/1999/xhtml">
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark1}}" name="remark1"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark2}}" name="remark2"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark3}}" name="remark3"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark4}}" name="remark4"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark5}}" name="remark5"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark6}}" name="remark6"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark7}}" name="remark7" />
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark8}}" name="remark8"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark9}}" name="remark9"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark10}}"  name="remark10" />
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark11}}" name="remark11" />
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark12}}" name="remark12" />
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark13}}" name="remark13"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark14}}" name="remark14"/>
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->remark15}}" name="remark15"/>
</body>
</foreignObject>

<foreignObject xmlns="http://www.w3.org/2000/svg" id="_75214" data-name="75214" class="cls-1" x="843" y="154" width="70" height="25">
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->TOLocation}}" name="TO" />
</body>
</foreignObject>
<foreignObject xmlns="http://www.w3.org/2000/svg" id="_31069" data-name="31069" class="cls-1" x="945" y="154" width="70" height="25">
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->FromLocation}}" name="From" />
</body>
</foreignObject>
<foreignObject
xmlns="http://www.w3.org/2000/svg" id="_968745" data-name="968745" class="cls-1" x="1045" y="154" width="90" height="25">
<body xmlns="http://www.w3.org/1999/xhtml">
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->Date}}" name="Date" />
</body>
</foreignObject>
<foreignObject xmlns="http://www.w3.org/2000/svg" id="_985123" data-name="985123" class="cls-1" x="634" y="140" width="90" height="25">
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->SerailNO}}" name="SerialNO" />
</body>
</foreignObject>
<foreignObject xmlns="http://www.w3.org/2000/svg" id="_96348" data-name="96348" class="cls-1" x="634" y="158" width="90" height="25">
<input type="text" @if(!empty($view)) readonly @endif value="{{$select->VehicleNO}}" name="VehicleNo" />
</body>
</foreignObject>
<foreignObject xmlns="http://www.w3.org/2000/svg"  id="_96348" data-name="96348" class="cls-1" x="35" y="158" width="150" height="25">
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->TripNO}}" name="TripNO">
</foreignObject>
...
<input type="text" @if(!empty($view)) readonly @endif  value="{{$select1->CashDetail1}}" name="cash1">
  ...
  <text id="_گاڑی_کے_پاسس_کيش_" data-name="        گاڑی کے پاسس کيش " class="cls-4" transform="translate(340.767 605.716) scale(1.05)">        <tspan class="cls-5">گاڑی</tspan> <tspan>کے</tspan> <tspan>پاسس</tspan> <tspan>کيش</tspan></text>
...
<input type="submit" value="submit"  style="position: fixed;bottom: 0;bottom FONT-VARIANT: JIS04;" />
</form>
