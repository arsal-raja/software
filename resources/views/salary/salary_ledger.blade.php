  ...
  <div class="">
    <div class="clearfix"></div>
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Salary Ledger Reporting</h2>
            <div class="clearfix"></div>
          </div>
          <form method="post" action="{{url('generate_salary_ledger')}}">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Salary Ledger Information</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                <?php $balance = 0; ?>
                @foreach($salary_ledger as $row)
                <tr onclick="javascript:showRow(this);">
                  <td>{{ $row->sl_id }}</td>
                  <td>
                    <?php
      								$date_format = date('d-m-Y',strtotime($row->sl_date));
        							echo $date_format;
        						?>
                  </td>
                  <td>{{ $row->sl_desc }}</td>
                  <td>{{ $row->sl_reference }}</td>
                  <td><?php echo $debit = $row->sl_debit; ?></td>
                  <td><?php echo $credit = $row->sl_credit; ?></td>
                  <td>
                    <?php
