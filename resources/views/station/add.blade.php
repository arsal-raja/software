                           ...
                           <div class="preview">
                               <div class="grid grid-cols-12 gap-2">
                                  <div class="col-span-6">
                                    ...
                                    <input id="regular-form-2" required type="text" value="@if(!empty($edit)) {{''}}    @endif"  class="form-control txtOnly" placeholder="Enter Name in English" name="name">
                                 </div>
                              ...
                              <div class="mt-2 grid grid-cols-12 gap-2 positon-relative phoneDivbar">
                                 <div class="col-span-12">
                                    <div class="mt-2">
                                       ...
                                       <input id="validd" type="number" class="form-control"   placeholder="Enter Phone" name="phones[]">
                                    </div>
