 ...
 <div class="flex">
       @include('includes.side-nav')
         <!-- BEGIN: Content -->
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Sub Station</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
            ...
            <form method="post" action="{{route('add-sub-station-process')}}"> 
               @csrf
            <div class="grid">
                     ...
                     <div class="intro-y box">
                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                              ...
                              <div class="mt-2 grid grid-cols-12 gap-2 positon-relative phoneDivbar1">
