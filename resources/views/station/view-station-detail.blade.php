                        ...
                        <div id="input" class="p-5">
                           <div class="preview">
                               ...
                               <div class="mt-2 c_name">
                                 ...
                                 <input id="regular-form-2" type="text" value="{{$stataion->name}}" readonly  class="form-control" placeholder="Enter Name in English" name="name">

                                 <input id="txtBox" name="name_urdu" type="text" value="{{$stataion->name_urdu}}" readonly    class="form-control UrduFont" placeholder="اردو میں نام درج  کریں" >
                              </div>
                              <div class="grid grid-cols-12 gap-2">
                              <div class="col-span-6 mt-2">
                                 <label for="txtBox" class="form-label">Agent Name</label>
                                  <input id="regular-form-5" type="text" class="form-control" value="{{$stataion->agent_name}}" readonly   placeholder="Enter Agent Name" name="agent_name">
                              </div>
                              <div class="col-span-6 mt-2">

                                 <label for="txtBox" class="form-label">Commission</label>
                                  <input id="regular-form-5" type="text"  class="form-control" value="{{$stataion->commission}}" readonly  placeholder="Type in percentage" name="commission">
                              </div>
                              </div>
