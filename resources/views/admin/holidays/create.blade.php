            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <input class="form-control form-control-inline date-picker" data-date-format="dd-mm-yyyy" name="date[0]" type="text" value="" placeholder="Date"/>
...
<script>
    ...
    $('#plusButton').click(function(){
        ...
        $i = $i+1;
        $(' <div class="form-group"> ' +
                '<div class="col-md-6"><input class="form-control form-control-inline date-picker'+$i+'" name="date['+$i+']" type="text" value="" placeholder="Date"/></div>' +
