...
<body class="main">
       ...
       <div class="content">
            ...
            <!-- END: Top Bar -->
             <form method="post"  autocomplete="off" @if(!empty($query)) action="{{route('edit-extra-porcess')}}" @endif @if(empty($query)) action="{{route('SaveExtra')}}" @endif>
               @csrf
            <div class="grid">
                        ...
                        <div id="Inventory">
                           ...
                           <div class="preview">
                               ...
                               <div class="col-span-12">
                                    ...
                                    <option  @if(!empty($query)) @if($rowcompany->id ==$query->ItemName) {{'selected'}}   @endif @endif  >{{$rowcompany->inventory_name}} |  Rate : {{$rowcompany->rate}} </option>
                                    @endforeach
                                        </select>
                                    </div>
                              ...
                              <div class="mt-2 grid grid-cols-12 gap-2 positon-relative">
                                 ...
                                 <input id="regular-form-2" @if(!empty($query)) value="{{$query->Quantity}}" @endif name="quantity" type="text" class="form-control" placeholder="Enter Litre">
                              </div> 
                              ...
                              <table id="example" class="display nowrap dataTable" style="width:100%">
                                 ...
                                 <tbody><?php $counter = 1; ?>
                                    @foreach($inventory as $invent)
                                     <tr>
                                     <td>{{$counter++}}</td>
                                         <td>{{$invent->inventory_name}}</td>
                                         <td>{{$invent->Quantity}}</td>
                                         <td>{{$invent->Date}}</td>
                                         <td>
                                         <a href="{{route('edit-extra',['id' =>$invent->id])}}">Edit </a> |
                                         <a href="{{route('delete-extra',['id' =>$invent->id])}}"> Delete </a> </td>
