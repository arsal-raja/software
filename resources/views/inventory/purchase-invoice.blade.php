                    ...
                    <ul>
                        ...
                        <div id="Inventory">
                            <div id="input" class="p-5">
                                ...
                                <form autocomplete="off" method="post" action="{{route('generateinvoice')}}">
                                    @csrf
                              ...
                              <div class="col-span-4 positon-relative">
                                ...
                                @foreach($company as $companyRow)
                                    <option value="{{$companyRow->id}}">{{$companyRow->ShopName}}</option>
                                @endforeach
                                </select>
                              </div>  
                              <div class="col-span-4 positon-relative">
                            ...
                            <button type="submit" class="btn btn-danger mt-5">Generate</button>
                            </form>
                        </div>
                           ...
                           <div class="preview">
                               ...
                               <BR><BR>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                    <td>{{$previousbalance->Amount}}</td>
                                    <td>
                                        @if($previousbalance->Amount != 0)
                                        <a href="{{route('clearshopamount',['id' => $previousbalance->shopcode])}}">Clear Amount</a></td>
                                        @endif
                                    </tr>
                                </tbody>
                              </table>
                                 <BR><BR>  
                               <form method="post" action="{{route('savegenerateinvoice')}}">
                              ...
                              <table id="example" class="display nowrap dataTable">
                                ...
                                <tr>
                                 <td>  @if($queryRow->status != 0)
                                 <input class="checkbox" type="checkbox" name="invoices[]" value="{{$queryRow->id}}">
                                 @else
                                 Cleared
                                 @endif 
                                </td>   
                                 <td>{{$counter++}}</td>
                                    <td>{{$queryRow->invoice}}</td>
                                    <td>{{$queryRow->Date}}</td>
                                    <td>{{$queryRow->Amount}}</td>
                                    </tr>
                                    @endforeach
                                    <tfoot>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td> <button type="submit" class="btn btn-primary mt-5">CLEAR</button></td>
                                    </tr>
                                    </tfoot>
