                     ...
                     <div class="intro-y box">
                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                           <h2 class="font-medium text-base mr-auto">
                              Add Inventory Packing
                           </h2>
                        </div>
                        <form method="post" autocomplete="off" @if(!empty($query)) action="{{route('edit-packing-process')}}" @endif @if(empty($query)) action="save-packing" @endif>
                        ...
                        <div id="Oil">
                           ...
                           <div class="preview">
                              ...
                              <div class="col-span-4 positon-relative">
                                 <label for="regular-form-2" class="form-label">Packing Name</label>
                                 <div class="error"></div>
 <input id="regular-form-2" type="text" @if(!empty($query)) value="{{$query->PackingName}}" @endif name="PackName" class="form-control" placeholder="Enter Inventory Name" >
                              ...
                              <select  id="regular-form-2" name="UOM" class="form-control">
                                 <option>Please Select... </option>      
                                    <option @if(!empty($query)) @if($query->Category == 'KG') {{'selected'}}  @endif @endif>KG</option>   
                                    <option @if(!empty($query)) @if($query->Category == 'Liters') {{'selected'}}  @endif @endif>Liters</option>   
                                    <option @if(!empty($query)) @if($query->Category == 'Dozen') {{'selected'}}  @endif @endif>Dozen</option>     
                                    <option @if(!empty($query)) @if($query->Category== 'Piece') {{'selected'}}  @endif @endif>Piece</option>
                               </select>
                              </div>
                              </div>   
                              ...
                              <table id="examples" class="display nowrap dataTable" style="width:100%">
                                 <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->Category}}</td>
                                        <td>
                                            <a href="{{route('edit-packing',['id'=>$row->id])}}">Edit</a>
                                            <a href="{{route('delete-packing',['id'=>$row->id])}}">Delete</a></td>
                                    </tr>
                                    @endforeach
