...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <div class="top-bar">
               <!-- BEGIN: Breadcrumb -->
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">SuggestList</a> </div>
               <!-- END: Breadcrumb -->
               <!-- BEGIN: Search -->
            ...
            <form method="post" @if(!empty($query)) action="{{route('edit-suggest-porcess')}}" @endif @if(empty($query)) action="{{route('add-suggestion-process')}}" @endif> 
               @csrf
            <div class="grid">
                           ...
                           <div class="preview">
                               <div class="grid grid-cols-12 gap-2">
                                 <div class="col-span-6">
                                    ...
                                    <input id="regular-form-2" type="text" class="form-control" placeholder="customer name" @if(!empty($query)) value="{{$query->suggest_name}}" @endif name="suggestname">
                                ...
                                <input type="hidden" name="id" value="{{$query->id}}">
                                 ...
                                 <div class="col-span-6">
                                    <label for="regular-form-1" class="form-label">Labour Charges</label>
                                    <input id="regular-form-2" type="text" class="form-control" placeholder="labour" @if(!empty($query)) value="{{$query->Labour_suggest}}" @endif name="suggestlabour">
                              ...
                              <div class="col-span-6">
                                    ...
                                    <select id="regular-form-2" class="form-control Select" name="suggeststation">
                                    <option>Please Select</option>
                                   @foreach($row as $colum)
                                    <option @if(!empty($query)) @if($query->suggest_station == $colum->id) {{'selected'}} @endif @endif value="{{$colum->id}}">{{$colum->name}}</option>
                                  @endforeach
                                    </select>
                                 </div>
                                    ...
                                    <select id="regular-form-2" class="form-control" name="suggestpackage">
                                    <option>Please Select</option>
                                 @foreach($data as $value)
                                    <option @if(!empty($query)) @if($query->suggest_package == $value->id) {{'selected'}} @endif @endif value="{{$value->id}}">{{$value->packagename}}</option>
                                    @endforeach
                                    </select>
                                 </div>
                              </div>
                              <div class="grid grid-cols-12 gap-2">
                                 <div class="col-span-6">
                                    ...
                                    <input id="regular-form-2" type="text" class="form-control" placeholder="freight" @if(!empty($query)) value="{{$query->suggest_freight}}" @endif name="suggest_freight">

                                 </div>
                                 <div class="col-span-6">
                                    <label for="regular-form-1" class="form-label">Date</label>
                                    <input id="regular-form-2" type="date" class="form-control" placeholder="name" @if(!empty($query)) value="{{$query->suggest_date}}" @endif name="suggestdate">
