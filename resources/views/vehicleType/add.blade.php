    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            @if (empty($select))
                ...
                @else
                    <form method="post" action="{{ route('vehicleType.edit') }}">
            @endif
                            ...
                            <div id="input" class="p-5">
                                ...
                                <div class="preview">
                                    ...
                                    <div class="mt-2 c_name">
                                        <label for="regular-form-2" class="form-label">Vechile Category</label>
                                        <input required id="regular-form-2" type="text"
                                            value="@if (!empty($vehicleType)) {{ $vehicleType->name }} @endif"
