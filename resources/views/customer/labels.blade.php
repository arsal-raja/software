...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <!-- END: Top Bar -->
            <form method="post" action="{{route('save-labels')}}"> 
               @csrf
            <div class="grid">
               <div class="intro-y flex items-center mt-12">
                  <h2 class="text-lg font-medium mr-auto">
                   Customers Label Form
                  </h2>
               </div>
                           ...
                           <div class="preview">
                               <div class="grid grid-cols-12 gap-2">
                                 <div class="col-span-6">
                                    ...
                                    <select id="regular-form-2"  class="form-control" name="CustomerID">
                                        ...
                                        @endforeach
                                                  ...
                                                  <div class="mt-2 grid grid-cols-12 gap-2 positon-relative phoneDivbarnew">
                                 <div class="col-span-12">
                                    <div class="mt-2">
                                       <label for="regular-form-5" class="form-label">Select Packages</label>
                                       <select  class="form-control"  name="phones[]">
                                           @foreach($Selectpackages as $packagerows)
                                           <option value="{{$packagerows->id}}">{{$packagerows->packagename}}</option>
                                           @endforeach
                                        </select>
                                    </div>
                                    <button class="btn btn-primary mt-5 AddMorePhonenew">Add More</button>
                                 </div>
                              </div>
            ...
            <div id="input" class="p-5">
                           <div class="preview">
                              <table id="example" class="display nowrap" style="width:100%">
                                 ...
                                 <tbody>
                                     @foreach($labels as $rowlabels)
                                       <tr>     
                                    <td>{{$rowlabels->Cname}}</td>
                                    <td>{{$rowlabels->ClName}}</td>
                                        </tr>
                                     @endforeach
...
$("input[name=commission]").on("keypress", function(e){
     ...
     if(myval.length > 1) {
      ...
      <script>
      $(document).ready(function() { var max_fields = 10; var wrapper = $(".phoneDivbarnew"); var add_button = $(".AddMorePhonenew"); var x = 1; $(add_button).click(function(e){ e.preventDefault(); if(x < max_fields){ x++; $(wrapper).append('<div class="col-span-12"><div class="mt-2"><label for="regular-form-5" class="form-label">Select Packages</label><select  class="form-control"  name="phones[]">   @if(!empty($Selectpackages))  @foreach($Selectpackages as $packagerows)<option value="{{$packagerows->id}}">{{$packagerows->packagename}}</option>@endforeach @endif </select>'); } });
