        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="x_panel">
            ...
            <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <form method="post" action='{{url('getCustomerLedgerRecord')}}'>

                <input type="hidden" value="{{csrf_token()}}" name="_token" />

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">

                  <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Customer's Name</span>
                  ...
                  <div class="col-md-8 col-sm-8 col-xs-12">
                      ...
                      <select name="customer_id" id="customer_id" class="form-control col-md-7 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <input type="submit" id="view" name="insertdata" class="btn btn-success" value="View Customer Info">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_title">
            ...
            <h2>Generate Date Wise Ledger Report of Customer</h2>
          ...
          <div class="x_content">
            ...
            <span id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <form name="form2" method="post" action='{{url('getCustomerLedgerReport')}}'>

                <input type="hidden" value="{{csrf_token()}}" name="_token" />

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">

                  <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Select a customer
