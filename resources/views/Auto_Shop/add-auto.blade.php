   ...
   @include('includes.side-nav')
         ...
         <div class="content">
            ...
            <div class="top-bar">
               ...
               <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">AutoShop</a> </div>
                  ...
                  <div class="intro-y col-span-12 lg:col-span-12">
                     ...
                     <div class="intro-y box">
                        ...
                        <form method="post" autocomplete="off"
                         @if(!empty($query)) action="{{route('save-edit-autoshop')}}" @endif
                         @if(empty($query)) action="{{route('save-autoshop')}}" @endif>
                         @csrf
                           ...
                           <div class="preview">
                              ...
                              <input type="hidden" name="id" value="{{$query->id}}">
                                @endif 
                                 ...
                                 <label for="regular-form-2" class="form-label">Shop Name</label>
                                     <div class="error"></div>
                                 <input id="regular-form-2" name="name" @if(!empty($query))  value="{{$query->ShopName}}"  @endif type="text" class="txtOnly form-control" placeholder="Enter a Shop Name" required>

                              </div>

                              <div class="mt-2 grid grid-cols-12 gap-2 positon-relative cateDivbar">
                             ...
                             <!-- <div class="mt-2">
                                 ...
                                 <label for="regular-form-4" class="form-label">Vendore Name</label>

                                 <input required id="regular-form-4" type="text" @if(!empty($query))  value=""  @endif name="vendorName" class="form-control" placeholder="Enter Vendore Name">
                              ...
                              <div class="mt-2 grid grid-cols-12 gap-2 positon-relative phoneDivbar">
                                 ...
                                 <div class="col-span-12">
                                    ...
                                    <div class="mt-2">
                                       ...
                                       <label for="regular-form-5" class="form-label">Contact No</label>
                                             <div class="numericmerror"></div>
                                       <input required id="regular-form-5" type="text" @if(!empty($query))  value="{{$query->Contact}}"  @endif name="Contact" class="numericOnly form-control" placeholder="Enter Contact No.">
                              ...
                              <div class="mt-2">
                                 ...
                                 <label for="regular-form-4" class="form-label">Address</label>
  
                                 <input required type="text" id="regular-form-6" @if(!empty($query))  value="{{$query->Address}}"  @endif name="Address" class="form-control" placeholder="Enter Address">
...
<tbody>
   ...
   <tr>
      ...
      <td>
<a href="edit-autoshop/{{$row->id}}" > Edit | </a>
<a href="delete-autoshop/{{$row->id}}" > Delete </a>
      </td>
