...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <form method="post" autocomplete="off" action="{{route('add-vehicle-voucher-expense')}}"> 
               @csrf
            <div class="grid">
                           ...
                           <div class="preview">
                              ...
                              <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Voucher NO</label>
                                  <input id="regular-form-5" readonly type="text" class="form-control" value="{{$id}}"  name="voucherNO">
                              </div>
                              <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Vehicle NO</label>
                                 <?php
                                   $vehicle = DB::table('now_vehicles')->where('id',$select->VehicleNO)->first();
                                 ?>
                                  <input id="regular-form-5" readonly type="text" class="form-control" value="{{$vehicle->vno}}"  name="vehicle">
                              </div>
                              <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Cash IN Hand</label>
                                  <input id="regular-form-5" readonly type="text" class="form-control" value="{{$select->Amount}}"  name="cash">
                              </div>
                              
                              <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Trip NO</label>
                                  <input id="regular-form-5" readonly type="text" class="form-control" value="{{$select->TripNO}}"  name="trip">
                              </div>
                              </div>
                              <div class="mt-2 positon-relative other">
                              <div class="col-span-3">
                                <label for="regular-form-1" class="form-label">Expense Detail</label>
                                  <input type="text" placeholder="Enter Details" class="form-control" name="Details[]">
                              </div>
                              <div class="col-span-3">
