                           ...
                           <div class="modal-body">
                              <div class="preview">
                                 ...
                                 <table class="Saif_Table_Noshera">
                                    ...
                                    <?php
                                   $builties =  DB::table('now_builty')->where('builty_status','in warehouse')->get();
                                      foreach($builties as $builty){
                                           ...
                                           echo '
                                            <tr>
                                               <td><input type="checkbox"  id="track"  name="trno[]"  value="'.$builty->id.'"> <label for="track">Bilty NO # '.$builty->id.'</label></td>
                                               <td >'.$stast.'</td>
