...
@section('main-content')
 ...
 <div class="flex">
      ...
      @include('includes.side-nav') 
            ...
            <!-- END: Top Bar -->
            <form method="post" action="{{route('save-edit-vehicle-voucher')}}"> 
               @csrf
            <div class="grid">
                           ...
                           <div class="preview">
                              ...
                              <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Voucher NO</label>
                                  <input id="regular-form-5" type="text" class="form-control"  value="{{$select->VoucherNO}}" readonly   name="voucherNo">
                              </div>
                   
                                    <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Rent</label>
                                  <input id="regular-form-5" type="text" class="form-control"  value="{{$select->Rent}}"   name="Rent">
                              </div>
                              
                              <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Truck NO</label>
                                  <input id="regular-form-5" type="text" class="form-control"  value="{{$select->TruckNO}}"  name="TruckNO">
                              </div>
                              
                              <div class="col-span-3 mt-2">
                                 <label for="txtBox" class="form-label">Date</label>
                                  <input id="regular-form-5" type="date" class="form-control"  value="{{$select->Date}}" name="Date">
                              </div>
                              </div>
                              <BR>
                             ...
                             $selectstation = DB::table('now_station')->get();
                             ?>
                             <div class="grid grid-cols-12 gap-2">
                                ...
                                $totalamount[] = $charges->Charges;
                                 ?>
                                  <select class="form-control" name="stationName[]">
                                    @foreach($selectstation as $stationIdName)
                                    <option value="{{$stationIdName->id}}" @if($charges->station == $stationIdName->id) {{'selected'}} @endif >{{$stationIdName->name}}</option>  
                                    
                                    @endforeach
                                    </select> 
                                      <input id="regular-form-5" type="hidden" class="form-control"  value="{{$charges->id}}"    name="stationchargesID[]">
                              </div>
                                    <div class="col-span-6 mt-2">
                                
                                  <input id="regular-form-5" type="text" class="form-control"  value="{{$charges->Charges}}"    name="stationAmount[]">
                            ...
                            @foreach($stationexpense as $chargesE)  
                              ...
                              <div class="col-span-6 mt-2">
                                ...
                                $totalamountexpense[] = $chargesE->Amount;
                                 ?>
                                  <input id="regular-form-5" type="text" class="form-control"  value="{{$chargesE->Detail}}" name="Detial[]">
                            
                              </div>
                                    <div class="col-span-6 mt-2">
                        
                                  <input id="regular-form-5" type="text" class="form-control"  value="{{$chargesE->Amount}}" name="Expenseamount[]">
                                   <input id="regular-form-5" type="hidden" class="form-control"  value="{{$chargesE->id}}" name="ExpenseID[]">
                              </div>
                              </div>
                            @endforeach
                           </div>
                             ...
                             <div class="grid grid-cols-12 gap-2">
                              <div class="col-span-12 mt-2">
                                 ...
                                 <input type="submit" name="submit" value="Save" class="btn btn-primary mt-5">
                              </div>
                              </div>
                        </div>
                     </div>
