               ...
               <div class="printViewHeader_table">
                  <table>
                     ...
                     <tr>
                        ...
                        <td> {{ ($sql3) ? $sql3->supplier : NULL }} <?php  // !empty($sql3->supplier) ? $sql3->supplier : ''; ?> </td>
                        <td>
                           ...
                           @endif   
                            ...
                            <?php    
                                ...
                                $mb = DB::table('manual_book')->join('now_station','manual_book.station','now_station.id')->where('manual_book.TRNO',$sql1->trno)->first();
                                 
                                    $receivername   =  $mb->ReceiverName;
                                    $sendername     =  $mb->SenderName; 
                                    ...
                                    ?>
                                     <tr>
                                        ...
                                        <td>{{$receivername}}</td>
                                        <td>{{$mb->name}}</td>
                                        <td> {{ ($mb) ? $mb->Quantity : NULL }} <?php  // !empty($sql3->quantity) ? $sql3->quantity : ''; ?>  </td>
                                        <td> {{ ($mb) ? $mb->Description : NULL }} <?php // !empty($sql3->brand) ? $sql3->brand : ''; ?> </td>
                                        <td> {{$mb->status}} </td>
                                        <td> <?php  // !empty($sql3->supplier) ? $sql3->supplier : ''; ?> </td>
                                        <td> @php $total[]  = $mb->Amount; @endphp 
                                           {{$mb->Amount}}
                                        </td>
                                     </tr>
                                    <?php
                  ...
                  <table border="2">
                     ...
                     <?php 
                        $netreceivableamount = $nettotalrent + ($otheramount) - $nettotalsupply -  $deliverycharges - $VehicleRent  ;
                        ?>   
                     <tr>
                        <td>Net Amount</td>
